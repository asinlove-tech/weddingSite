export const EventCard = ({ event, delay }) => (
    <article
        ...
        className={`reveal ${delay} group flex flex-col items-center gap-7 rounded-[2.5rem] border border-[#B08D3F]/25 bg-[#FAF5EC]/92 px-8 py-11 shadow-[0_40px_70px_-45px_rgba(43,38,32,0.45)] backdrop-blur-md`}
    >
        ...
        <div className="text-center">
            ...
            <p className="text-sm uppercase tracking-[0.22em] text-[#2B2620]/85">
                {event.date}
            </p>
